...
public class WorkerSendMessageToAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrowBack.setOnClickListener(new View.OnClickListener() {
            ...
            {
                Intent intent = new Intent(WorkerSendMessageToAdmin.this, WHome.class);
    ...
    private void send(String reportsub, String reportmes) {
        ...
        Intent intent = new Intent(WorkerSendMessageToAdmin.this, WHome.class);
        startActivity(intent);
        Toast.makeText(WorkerSendMessageToAdmin.this, "Your report has been sent!", Toast.LENGTH_SHORT).show();
/*
